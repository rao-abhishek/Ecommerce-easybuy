...
public class AllOrders extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			PreparedStatement sql = con.prepareStatement("select p.product_name , p.product_price , p.pid , p.product_ext, o.oid from order_history as o , products as p where uid = (?) and order_placed=1 and o.pid=p.pid order by order_time desc;");
